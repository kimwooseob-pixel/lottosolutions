...
// 회차별 당첨번호 (초기 시드) — RTDB에는 winningNumbers/{회차}: { numbers, timestamp }
const winningNumbersSeed = {
...
for (const [draw, nums] of Object.entries(winningNumbersSeed)) {
    updates[`/winningNumbers/${draw}`] = {
        numbers: nums,
        timestamp: now
    };
}
